...
class PMTfiedDatasetPyArrow(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        #Scaling Energy with number of doms
        n_doms_tensor = torch.tensor(n_doms, dtype=torch.float32).clamp(min=1.0)
        energy_scaled_target = energy / n_doms_tensor
        ...
        return Data(x=x_tensor, n_doms=n_doms, event_no=event_no, feature_path=feature_path, energy=energy_scaled_target, energy_original=energy, azimuth_neutrino=azimuth, zenith_neutrino=zenith, dir3vec=dir3vec, dir3vec_lepton=dir3vec_lepton, pid=pid)